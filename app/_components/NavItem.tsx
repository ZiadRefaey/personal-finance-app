...
export default function NavItem({
  ...
  return (
    <motion.li
      ...
      } pt-2 pb-3 px-[22px]  rounded-t-lg h-full xl:h-auto xl:w-full xl:rounded-tl-none  transition-all duration-300 flex flex-col items-center justify-cente gap-1 cursor-pointer xl:py-4`}
    >
